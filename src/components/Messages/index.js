...
var _CardMessage = require('./CardMessage');

var _CardMessage2 = _interopRequireDefault(_CardMessage);
...
var Message = function (_Component) {
  ...
  Message.prototype._renderMessageOfType = function _renderMessageOfType(type) {
    switch (type) {
      ...
      case 'card':
        return _react2.default.createElement(_CardMessage2.default, this.props.message);
      default:
